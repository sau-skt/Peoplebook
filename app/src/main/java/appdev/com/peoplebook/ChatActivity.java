...
import appdev.com.peoplebook.Adapter.ChatActivityAdapter;
    ...
    private void getFriends() {
        frienddatabasereference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerView.setAdapter(new ChatActivityAdapter(friendnames,friendstatus, friendprofileimage, friendusernames, username));
            }
