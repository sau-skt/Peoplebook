...
import appdev.com.peoplebook.Adapter.FriendsAdapter;
...
public class FriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frienddatabasereference = FirebaseDatabase.getInstance("https://peoplebook-65c7c-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Friends").child(username);
        getFriends();
    ...
    private void getFriends() {
        frienddatabasereference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerView.setAdapter(new FriendsAdapter(friendnames,friendstatus, friendprofileimage, friendusernames, username));
            }
    ...
    private void Widgets() {
        recyclerView = (RecyclerView) findViewById(R.id.friends_activity_recyclerview);
    }
}